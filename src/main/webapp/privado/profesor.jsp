	 ...
	 <table style="width:100%">
		  ...
		  <c:forEach items="${listaCursos }" var="curso">
			  <tr>
			    ...
			    <td><a href="${pageContext.request.contextPath}/privado/profesor?id=${curso.id }">Eliminar curso </a></td>
			  </tr>
		  </c:forEach>

	</table> 
	
	<form action="${pageContext.request.contextPath}/privado/profesor" method="post">
